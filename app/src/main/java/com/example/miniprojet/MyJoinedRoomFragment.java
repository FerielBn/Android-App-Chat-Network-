    ...
    public void onStart() {
        ...
        room.GetMyCreatedRooms(getContext(), new OnDataRecievedRooms() {
            ...
            public void callback(ArrayList<Room> rooms) {
                ...
                AdapterOneRoom adapter = new AdapterOneRoom(getContext(),created_rooms,create_room_fragm,transaction,R.layout.one_room_item_white);
        ...
        room.GetMyJoinedRooms(getContext(), new OnDataRecievedRooms() {
            ...
            public void callback(ArrayList<Room> rooms) {
                ...
                AdapterOneRoom adapter = new AdapterOneRoom(getContext(),joined_rooms,create_room_fragm,transaction,R.layout.one_room_item_white);
                GridLayoutManager gridLayoutManager = new GridLayoutManager(getContext(),1,GridLayoutManager.VERTICAL,false);
